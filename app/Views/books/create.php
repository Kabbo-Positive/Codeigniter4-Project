        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('books/book-store')?>" name="createForm" id="createForm" method="POST">

                    <div class="form-group">
                        <label for="">Title</label>
                        <input type="text" placeholder="Enter Book Title" name="title" class="form-control"  required>
                    </div>

                    <div class="form-group">
                        <label for="">ISBN No</label>
                        <input type="text" placeholder="Enter Book ISBN Number" name="isbn_no" class="form-control" required>
                    </div>

                    <div class="form-group">
                        <label for="">Author</label>
                        <input type="text" placeholder="Enter Book Author Name" name="author" class="form-control"  required>
                    </div>
